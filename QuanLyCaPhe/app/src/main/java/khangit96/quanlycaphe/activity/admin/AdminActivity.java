...
import khangit96.quanlycaphe.activity.LoginActivity;
    ...
    public void initGridViewAdmin() {
        ...
        gvAdmin.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int pos, long l) {
                ItemManage item = itemManageList.get(pos);

                if (item.itemKey.equals("Exit"))
                    finish();
                else if (item.itemKey.equals("Order"))
                    startActivity(new Intent(AdminActivity.this, ManageActivity.class));
                else if (item.itemKey.equals("Table"))
                    startActivity(new Intent(AdminActivity.this, AdminTableActivity.class));
