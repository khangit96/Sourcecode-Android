...
import com.hnib.smslater.utils.ItemClickSupport.OnItemClickListener;
...
public class PendingSmsFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.d("binh ListSMSFragment", "onCreate");
    ...
    private void loadSmsPendingFromDatabase() {
        Log.d("binh ListSMSFragment", "load SMS from database");
        smsPojos = new Select()
                .all()
                .from(SmsPojo.class)
                .where("status=?", 0)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("binh ListSMSFragment", "onCreateView");
    ...
    protected void initAdmob(View view) {
        ...
        if (adView != null) {
            ...
            if (AppConstants.isAdmobEnabledPendingSmsScreen) {
    ...
    public void onResume() {
        ...
        Log.d("binh ListSMS Fragment", "onResume");
