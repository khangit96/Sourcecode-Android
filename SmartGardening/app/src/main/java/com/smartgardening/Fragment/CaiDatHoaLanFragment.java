...
import com.smartgardening.Model.CaiDatHoaLan;
import com.smartgardening.R;

import static android.icu.lang.UCharacter.GraphemeClusterBreak.T;

public class CaiDatHoaLanFragment extends Fragment {

    View v;
    TextView tvTenHeThong, tvHenGioPhunSuong, tvThoiGianCapNhatDuLieu, tvThoiGianPhunSuong, tvDoAmKhongKhiThapNhatt;
    Button btTenHeThong, btHenGioPhunSuong, btThoiGianCapNhat, btThoiGianPhunSuong, btDoAmKhongKhiThapNhat;
    static int check = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_cai_dat_hoa_lan, container, false);
    ...
    public void khoiTao() {
        ...
        mData.child("2/CaiDat").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                CaiDatHoaLan caiDatHoaLan = dataSnapshot.getValue(CaiDatHoaLan.class);

                tvHenGioPhunSuong = (TextView) v.findViewById(R.id.tvHenGioPhunSuong);
                tvThoiGianPhunSuong = (TextView) v.findViewById(R.id.tvThoiGianPhunSuong);
                tvThoiGianCapNhatDuLieu = (TextView) v.findViewById(R.id.tvThoiGianCapNhatDuLieu);
                tvDoAmKhongKhiThapNhatt = (TextView) v.findViewById(R.id.tvDoAmKhongKhiThapNhat);

                tvHenGioPhunSuong.setText(caiDatHoaLan.henGioPhunSuong);
                tvThoiGianPhunSuong.setText(String.valueOf(caiDatHoaLan.thoiGianPhunSuong) + " giây");
                tvThoiGianCapNhatDuLieu.setText(String.valueOf(caiDatHoaLan.thoiGianCapNhatDuLieu) + " phút");
                tvDoAmKhongKhiThapNhatt.setText(String.valueOf(caiDatHoaLan.doAmKhongKhiThapNhat) + "%");
        ...
        btHenGioPhunSuong = (Button) v.findViewById(R.id.btHenGioPhunSuong);
        btHenGioPhunSuong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                RadialTimePickerDialogFragment rtpd = new RadialTimePickerDialogFragment()
                        .setOnTimeSetListener(new RadialTimePickerDialogFragment.OnTimeSetListener() {
                            ...
                            public void onTimeSet(RadialTimePickerDialogFragment dialog, int hourOfDay, int minute) {
                                ...
                                tvHenGioPhunSuong.setText(hourOfDay + ":" + minute);
                                ...
                                DatabaseReference mData = FirebaseDatabase.getInstance().getReference();
                                mData.child("2/CaiDat/henGioPhunSuong").setValue(thoiGianTuoi, listener);
        ...
        btThoiGianPhunSuong = (Button) v.findViewById(R.id.btThoiGianPhunSuong);
        btThoiGianPhunSuong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                check = 2;
        ...
        btDoAmKhongKhiThapNhat = (Button) v.findViewById(R.id.btDoAmKhongKhiThapNhat);
        btDoAmKhongKhiThapNhat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                check = 3;
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (!inputReview.getText().toString().equals("")) {
                    ...
                    if (check == 1) {
                        ...
                        mData.child("2/CaiDat/thoiGianCapNhatDuLieu").setValue(Integer.parseInt(inputReview.getText().toString()), listener);
                    } else if (check == 2) {
                        //thời gian tưới
                        ...
                        DatabaseReference.CompletionListener listener = new DatabaseReference.CompletionListener() {
                            ...
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                pg.dismiss();
                                tvThoiGianPhunSuong.setText(inputReview.getText().toString() + " giây");
                                Toast.makeText(getActivity(), "Cài đặt thời gian tưới thành công!", Toast.LENGTH_LONG).show();
                            }
                        };
                        mData.child("2/CaiDat/thoiGianPhunSuong").setValue(Integer.parseInt(inputReview.getText().toString()), listener);
                        ...
                        DatabaseReference.CompletionListener listener = new DatabaseReference.CompletionListener() {
                            ...
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                pg.dismiss();
                                tvDoAmKhongKhiThapNhatt.setText(inputReview.getText().toString() + "%");
                                Toast.makeText(getActivity(), "Cài đặt độ ẩm đất thấp nhất thành công!", Toast.LENGTH_LONG).show();
                            }
                        };
                        mData.child("2/CaiDat/doAmKhongKhiThapNhat").setValue(Integer.parseInt(inputReview.getText().toString()), listener);
                    }
                } else {
        ...
        builder.setNegativeButton("Đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (!edThongTin.getText().toString().equals("")) {
                    ...
                    DatabaseReference mData = FirebaseDatabase.getInstance().getReference();
                    mData.child("2/ThongTinHeThong/tenHeThong").setValue(edThongTin.getText().toString(), listener);
                } else {
