...
public class ThongTinHoaLanFragment extends Fragment {

    View v;
    TextView tvCamBienKK, tvCamBien1, tvCamBien2, tvCamBien3, tvCamBienNhietDo;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_thong_tin_hoa_lan, container, false);
    ...
    public void getDataHoaCaiFromFirebase() {
        ...
        tvCamBienKK = (TextView) v.findViewById(R.id.tvCamBienKK);
        ...
        mData.child("2/DuLieu").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {

                String doAmKK = dataSnapshot.child("DoAmKhongKhi").getValue().toString();
                tvCamBienKK.setText(doAmKK + "%");
