...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Boolean check= sensorManager.registerListener(this, camBienTruongGan, SensorManager.SENSOR_DELAY_NORMAL);
        if(check){
            Toast.makeText(getApplicationContext(), "Your phone is support proximity", Toast.LENGTH_LONG).show();
        }else {
            Toast.makeText(getApplicationContext(), "Your phone doesn't support proximity", Toast.LENGTH_LONG).show();
        }
    }
